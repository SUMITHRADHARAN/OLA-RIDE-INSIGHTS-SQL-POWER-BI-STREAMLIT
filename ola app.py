...
def preprocess_data(df):
    """
    Cleans the raw OLA dataset: Handles nulls, standardizes types, 
...
# 1. Developer Info (Right Aligned)
st.markdown(f"""
<div style="text-align: right; line-height: 1.2; margin-bottom: 20px;">
    <span style="font-weight: bold; font-size: 18px; color: white;">Name: SUMITHRA D</span><br>
    <span style="font-weight: bold; font-size: 18px; color: white;">Roll Number: 28552</span><br>
    <span style="font-weight: bold; font-size: 18px; color: white;">BATCH: E332</span>
</div>
""", unsafe_allow_html=True)

# 2. Styled Title Box with 4-sided OLA Lime Border
st.markdown(f"""
<div style="
    padding: 30px; 
    background-color: {OLA_CARD}; 
    border-radius: 10px; 
    /* This creates the frame on all sides */
    border: 5px solid {OLA_LIME}; 
    box-shadow: 0px 0px 20px {OLA_LIME}44; /* Added a subtle lime glow */
    margin: 10px 0px;
    text-align: center;
">
    <h1 style="
...
# =================================================================
st.sidebar.image(r"C:\Users\dhara\Documents\Interns\Labmentix\2. Ola Ride insights\ola.png", use_container_width=True)
